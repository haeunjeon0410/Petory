...
class _HomePageState extends State<HomePage> {
  ...
  IconData _activityIcon(String level) {
    if (level == '저조') return PhosphorIconsBold.batteryEmpty;
    if (level == '활발') return PhosphorIconsBold.batteryFull;
    return PhosphorIconsBold.batteryMedium;
  }
              ...
              child: Material(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      buildOption('저조', PhosphorIconsBold.batteryEmpty),
                      buildOption('보통', PhosphorIconsBold.batteryMedium),
                      buildOption('활발', PhosphorIconsBold.batteryFull),
                    ],
                  ),
                ),
              ),
