    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        LayoutBuilder(builder: (context, constraints) => GestureDetector(
          ...
          child: SizedBox(height: 160, width: double.infinity, child: history.isEmpty ? const Center(child: Text("기록을 추가하여 추이를 확인하세요.", style: TextStyle(color: Color(0xFF605A55), fontSize: 12))) : CustomPaint(painter: MonotoneWeightChartPainter(history))),
        )),
        const SizedBox(height: 28),
        Row(children: [
          Expanded(child: _buildTrendSummary("현재 체중", "${currentWeight.toStringAsFixed(1)} kg", const Color(0xFF44403B))),
          const SizedBox(width: 12),
